...
![3-2-2-3-1-b]
 ...
 -  **앱 시작여부**를 설정한다. <br>
 -  **사용자 앱 등록**을 원할 경우 앱을 선택한다. <br>

5.  사용자 앱을 등록 할 경우 ‘사용자 앱 생성”, 사용자 앱 등록을 하지 않을 경우 ‘샘플 앱 생성” 버튼을 클릭하여 앱 개발환경 생성을 완료한다.
...
2.  상태 리스트에서 Status, CPU, Memory, Disk, UPTIME(updatetime), RESTART를 확인 할 수 있다.<br /> 
    "RESTART" 버튼을 클릭하면 인스턴스 재 시작이 가능하다.<br />
    "Connect" 버튼을 클릭하면 해당 인스턴스에 SSH 로 접속이 가능하다.<br />
![3-2-1-3-3-1-b]

3.  SSH Connect 로 인스턴스에 SSH 접속 할 수 있다.<br />
![3-2-1-3-3-1-ssh]
...
[3-2-1-3-3-1-b]:../images/user-portal/3-2-1-3-3-1-b.png
[3-2-1-3-3-1-ssh]:../images/user-portal/3-2-1-3-3-1-ssh.png
...
[3-2-2-3-1-b]:../images/user-portal/3-2-2-3-1-b.png
